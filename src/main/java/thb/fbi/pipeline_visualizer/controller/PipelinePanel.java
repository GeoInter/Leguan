...
public class PipelinePanel extends JPanel {
    ...
    String[] Registers = { "X0", "X1", "X2", "X3", "X4", "X5", "X6",
    ...
    public void paintComponent(Graphics g) {
        ...
        // g2d.drawString("m : " + m + ", (x,y): (" + x + ", " + y + ")", 20 , 590);
    ...
    public String getValueOfWire() {
        ...
        for (int i = 0; i < this.wire.length; i++) {
            for (int j = 0; j < this.wire[i].x.length - 1; j++) {
                ...
                double distance = Point.distance(x1, y1, x, y) + Point.distance(x, y, x2, y2)
                ...
                if (distance <= 0.1) {
                    ...
                    switch (i + 1) {
                        case 1:
                            ...
                            retStr = "" + this.currentFrame.nextPC;
                            if (mode == 2)
                                retStr = giveBinaryString(0, 32, retStr);
                            else if (mode == 3)
                                retStr = "Next PC";
                            break;
                        case 2: // PC Write Label
                            if (!this.currentFrame.isForwardingEnabled) {
                                // if unforwareded false, still check normal Data Hazard
                                boolean unforwarededHazard = this.currentFrame.hdUnit.checkUnforwardedDataHazard();
                                if (unforwarededHazard) { // prevent overriding
                                    retStr = "" + !unforwarededHazard;
                                } else {
                                    retStr = "" + !this.currentFrame.hdUnit.checkDataHazard();
                                }
                            } else {
                                retStr = "" + !this.currentFrame.hdUnit.checkDataHazard();
                            }
                            ...
                            break;
                        case 3:
                            retStr = "" + this.currentFrame.currentPC;
                            if (mode == 2)
                                retStr = giveBinaryString(0, 32, retStr);
                            else if (mode == 3)
                                retStr = "Current PC";
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            retStr = "" + (this.currentFrame.currentPC + 4);
                            if (mode == 2)
                                retStr = giveBinaryString(0, 32, retStr);
                            else if (mode == 3)
                                retStr = "PC + 4";
                            break;
                        case 6:
                            if (this.currentFrame.hdUnit.branchAddress != -1) {
                                retStr = "" + this.currentFrame.hdUnit.branchAddress;
                                if (mode == 2)
                                    retStr = giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                            ...
                            break;
                        case 7:
                            retStr = "" + this.currentFrame.hdUnit.checkBranchHazard();
                            if (mode == 2) {
                                if (retStr.equalsIgnoreCase("true"))
                                    retStr = "" + 1;
                                else
                        ...
                        case 9:
                            if (this.currentFrame.idExPipeline != null) {
                                retStr = "" + this.currentFrame.idExPipeline.PC;
                                if (mode == 2)
                                    retStr = giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 12:
                            if (this.currentFrame.idExPipeline != null) {
                                retStr = "" + this.currentFrame.idExPipeline.rt;
                                if (mode == 2)
                        ...
                        case 17:
                            if (this.currentFrame.idExPipeline != null) {
                                retStr = "" + this.currentFrame.idExPipeline.Offset;
                                if (mode == 2)
                        ...
                        case 22:
                            if (this.currentFrame.idExPipeline != null) {
                                if (this.currentFrame.idExPipeline.rd >= 0) {
                            ...
                            break;
                        case 23:
                            retStr = "" + this.currentFrame.tempWbRegWrite;
                            if (mode == 2) {
                                if (retStr.equalsIgnoreCase("true"))
                                    retStr = "" + 1;
                                else
                        ...
                        case 24:
                            if (this.currentFrame.idExPipeline != null)
                                retStr = "" + this.currentFrame.idExPipeline.WB.toString(mode);
                            else
                                retStr = "X";
                            if (mode == 3)
                        ...
                        case 25:
                            if (this.currentFrame.idExPipeline != null)
                                retStr = "" + this.currentFrame.idExPipeline.MEM.toString(mode);
                            else
                                retStr = "X";
                            if (mode == 3)
                        ...
                        case 26:
                            if (this.currentFrame.idExPipeline != null)
                                retStr = "" + this.currentFrame.cUnit.toString(mode);
                            else
                                retStr = "X";
                            if (mode == 3)
                        ...
                        case 28:
                            if (this.currentFrame.idExPipeline != null) {
                                retStr = "" + this.currentFrame.idExPipeline.rtValue;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "Rs Value";
                        ...
                        case 30:
                            if (this.currentFrame.exMemPipeline != null)
                                retStr = "" + this.currentFrame.exMemPipeline.MEM.toString(mode);
                            else
                                retStr = "X";
                            if (mode == 3)
                                retStr = "MemRead, MemWrite, Branch";
                        ...
                        case 33:
                            if (this.currentFrame.exMemPipeline != null)
                                retStr = "" + this.currentFrame.exMemPipeline.WB.toString(mode);
                            else
                                retStr = "X";
                            if (mode == 3)
                                retStr = "RegWrite, MemToReg";
                        ...
                        case 34:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExAluOp;
                                if (mode == 2)
                        ...
                        case 35:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExDestReg;
                                if (mode == 2) {
                                    if (retStr.equalsIgnoreCase("true"))
                                        retStr = "" + 1;
                                    else
                        ...
                        case 36:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExAluSource;
                                if (mode == 2) {
                                    if (retStr.equalsIgnoreCase("true"))
                                        retStr = "" + 1;
                                    else
                        ...
                        case 37:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExPC;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 38:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.exMemPipeline.PCBranch;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 42:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.fwdUnit.rtValue;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 43:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExI32Offset;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 44:
                            if (this.currentFrame.exMemPipeline != null) {
                                if (this.currentFrame.tempExFunction >= 0) {
                                    ...
                                    retStr = "" + giveBinaryString(26, 32, "" + this.currentFrame.tempExI32Offset);
                                    if (mode == 1)
                                        retStr = "" + Integer.parseInt(retStr, 2);
                                }
                            } else
                        ...
                        case 45:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExShiftLeft2Offset;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 46:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.fwdUnit.valueMuxA();
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 47:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.fwdUnit.valueMuxB();
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 48:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExOperand2;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 51:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.fwdUnit.rt;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(27, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 53:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.tempExRd;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(27, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 54:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.exMemPipeline.destReg;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(27, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 55:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.exMemPipeline.ALU_zero;
                                if (mode == 2) {
                                    if (retStr.equalsIgnoreCase("true"))
                                        retStr = "" + 1;
                                    else
                        ...
                        case 56:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.exMemPipeline.ALU_result;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                            ...
                            break;
                        case 57:
                            retStr = "" + this.currentFrame.fwdUnit.selectMuxA();
                            if (mode == 2)
                                retStr = "" + giveBinaryString(30, 32, retStr);
                            if (mode == 3)
                            ...
                            break;
                        case 58:
                            retStr = "" + this.currentFrame.fwdUnit.selectMuxB();
                            if (mode == 2)
                                retStr = "" + giveBinaryString(30, 32, retStr);
                            if (mode == 3)
                        ...
                        case 59:
                            if (this.currentFrame.memWbPipeline != null)
                                retStr = "" + this.currentFrame.memWbPipeline.WB.toString(mode);
                            else
                                retStr = "X";
                            if (mode == 3)
                                retStr = "RegWrite, MemToReg";
                            break;
                        case 60:
                            retStr = "" + this.currentFrame.tempMemMRead;
                            if (mode == 2) {
                                if (retStr.equalsIgnoreCase("true"))
                                    retStr = "" + 1;
                                else
                            ...
                            break;
                        case 61:
                            retStr = "" + this.currentFrame.tempMemMWrite;
                            if (mode == 2) {
                                if (retStr.equalsIgnoreCase("true"))
                                    retStr = "" + 1;
                                else
                        ...
                        case 62:
                            if (this.currentFrame.memWbPipeline != null) {
                                retStr = "" + this.currentFrame.hdUnit.branch;
                                if (mode == 2) {
                                    if (retStr.equalsIgnoreCase("true"))
                                        retStr = "" + 1;
                                    else
                        ...
                        case 63:
                            if (this.currentFrame.memWbPipeline != null) {
                                retStr = "" + this.currentFrame.hdUnit.ALUzero;
                                if (mode == 2) {
                                    if (retStr.equalsIgnoreCase("true"))
                                        retStr = "" + 1;
                                    else
                        ...
                        case 64:
                            if (this.currentFrame.memWbPipeline != null) {
                                retStr = "" + this.currentFrame.fwdUnit.RegWriteExMemFlag;
                                if (mode == 2) {
                                    if (retStr.equalsIgnoreCase("true"))
                                        retStr = "" + 1;
                                    else
                        ...
                        case 66:
                            if (this.currentFrame.memWbPipeline != null) {
                                retStr = "" + this.currentFrame.tempMemWriteData;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 67:
                            if (this.currentFrame.memWbPipeline != null) {
                                retStr = "" + this.currentFrame.memWbPipeline.ALU_result;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(0, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 69:
                            if (this.currentFrame.memWbPipeline != null) {
                                retStr = "" + this.currentFrame.memWbPipeline.destReg;
                                if (mode == 2)
                                    retStr = "" + giveBinaryString(27, 32, retStr);
                            } else
                                retStr = "X";
                        ...
                        case 76:
                            if (this.currentFrame.exMemPipeline != null) {
                                retStr = "" + this.currentFrame.exMemPipeline.MEM.MemRead;
                                if (mode == 2) {
                                    if (retStr.equalsIgnoreCase("true"))
                                        retStr = "" + 1;
                                    else
