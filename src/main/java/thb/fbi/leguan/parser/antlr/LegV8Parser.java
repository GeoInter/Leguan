...
public class LegV8Parser extends Parser {
	...
	public static final int
		...
		WS=11, COMMENT=12, LINE_COMMENT=13, COMMA=14, SEMI=15, EQUALS_SIGN=16, 
		SQUARE_BRACKET_LEFT=17, SQUARE_BRACKET_RIGHT=18, REGISTER=19, NUMBER=20, 
		SP=21, FP=22, LR=23, XZR=24, PointerDeclaration=25, PointerReference=26, 
		DataSegmentTypes=27, ASCII_String=28;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, null, "'STXR'", null, null, "'BR'", "'LDR'", 
			null, null, null, "','", "';'", "'='", "'['", "']'", null, null, "'SP'", 
			"'FP'", "'LR'", "'XZR'"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 33556478L) != 0 );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
