...
public class LegV8Parser extends Parser {
	...
	public static class DataSegmentContext extends ParserRuleContext {
		public List<DataSegmentVariableContext> dataSegmentVariable() {
			return getRuleContexts(DataSegmentVariableContext.class);
		}
		public DataSegmentVariableContext dataSegmentVariable(int i) {
			return getRuleContext(DataSegmentVariableContext.class,i);
		}
